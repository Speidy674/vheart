...
class BroadcastersChartWidget extends ChartWidget
{
    use HasBasicOverviewChartStuff;

    protected ?string $heading = 'Broadcasters Trend Overview';

    public static function canView(): bool
    {
        return auth()->user()->can(Permission::ViewAnyBroadcaster);
    }
