  ...
  <div class="mb-8">
    <div class="mb-10 text-center">
      <div class="mb-4 flex items-center justify-center gap-3">
        <Video class="h-6 w-6 text-gray-900/90 dark:text-white" />
    ...
    <div class="mb-8 grid gap-5 md:grid-cols-2">
      <div
        class="rounded-xl border border-gray-300/80 bg-white/65 p-6 transition-transform duration-200 hover:scale-[1.02] dark:border-white/10 dark:bg-black/25"
      >
    ...
    <div class="rounded-xl border border-red-300 bg-red-50/80 p-6 dark:border-red-400/30 dark:bg-red-900/10">
      <div class="flex items-start gap-3">
        <Shield class="mt-0.5 h-5 w-5 flex-shrink-0 text-red-600 dark:text-red-300" />
        <p class="text-sm leading-relaxed text-gray-800 dark:text-white/90">
            {{ __('blacklist') }}
        </p>
      </div>
