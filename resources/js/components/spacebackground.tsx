...
const StaticSpaceBackground = () => {
    ...
    useLayoutEffect(() => {
        ...
        const starColor = isDark ? 'rgba(255,255,255,' : 'rgba(80,80,80,';
        ...
        const planetColor2 = isDark
            ? 'rgba(145, 70, 255, '
            : 'rgba(145, 70, 255, ';
        const background = isDark ? '#0a0a1a' : '#EEF2F8';
        const starAlphaMultiplier = isDark ? 1 : 0.3;
        ...
        staticStars.forEach((star) => {
            ...
            const baseSize = isMobile ? star.s * 0.8 : star.s;
            const size = baseSize * (isMobile ? 1.2 : 1.0);
        ...
        if (!isMobile) {
            ...
            if (ctx) {
                const planet1X = width * 0.8;
                const planet1Y = height * 0.2;
                const planet1Radius = 48;
                ...
                planet1Gradient.addColorStop(0, `${planetColor1}0.6)`);
                planet1Gradient.addColorStop(0.6, `${planetColor1}0.4)`);
                planet1Gradient.addColorStop(1, `${planetColor1}0.2)`);
                ...
                planet2Gradient.addColorStop(0, `${planetColor1}0.6)`);
                planet2Gradient.addColorStop(0.6, `${planetColor1}0.4)`);
                planet2Gradient.addColorStop(1, `${planetColor1}0.2)`);
