@php
    ...
    try {
        ...
        $donationsResponse = Http::get("https://api.betterplace.org/de/api_v4/fundraising_events/" . EVENT_ID . "/opinions.json");
...
<section class="w-full">
    <div class="mx-auto grid max-w-7xl grid-cols-1 items-start gap-8 lg:grid-cols-2 lg:gap-12 mb-8">
        <x-ui.card class="flex w-full flex-col rounded-2xl border border-gray-200 bg-gradient-to-br from-white/70 via-white/85 to-white/70 p-6 shadow-xl ring-1 shadow-black/10 ring-black/5 md:p-8 lg:h-[55rem] dark:border-white/20 dark:bg-black/30 dark:!bg-none dark:ring-0 dark:shadow-purple-900/30">
            <div class="custom-scrollbar overflow-y-auto pr-2">
                @if($error)
                    <div class="rounded-xl border border-red-300/80 bg-red-50/60 p-4 dark:border-red-900/30 dark:bg-red-900/20">
                ...
                @else
                    <div class="space-y-6">
                        <h2 class="bg-gradient-to-r from-purple-700 via-gray-900 to-cyan-700 bg-clip-text text-2xl font-bold text-transparent sm:text-3xl dark:from-purple-300 dark:via-white dark:to-cyan-300">
                        ...
                        <div class="rounded-xl border border-gray-300/80 bg-white/60 p-6 dark:border-white/15 dark:bg-black/20">
                            <div class="mb-4 flex items-center justify-center gap-2 text-xs font-medium tracking-wider uppercase sm:text-sm">
                            ...
                            <div class="bg-gradient-to-r from-purple-700 via-gray-900 to-cyan-700 bg-clip-text text-center text-3xl font-bold text-transparent sm:text-4xl md:text-5xl dark:from-purple-300 dark:via-white dark:to-cyan-300">
        ...
        <x-ui.card class="flex w-full flex-col rounded-2xl border border-gray-200 bg-gradient-to-br from-white/70 via-white/85 to-white/70 p-6 shadow-xl ring-1 shadow-black/10 ring-black/5 md:p-8 lg:h-[55rem] dark:border-white/20 dark:bg-black/30 dark:!bg-none dark:ring-0 dark:shadow-purple-900/30">
            <div class="flex h-full flex-col">
                <h3 class="mb-6 bg-gradient-to-r from-purple-700 via-gray-900 to-cyan-700 bg-clip-text text-xl font-bold text-transparent sm:text-2xl dark:from-purple-300 dark:via-white dark:to-cyan-300">
                        ...
                        <div class="custom-scrollbar h-full max-h-[30rem] overflow-y-auto pr-2 lg:max-h-none">
                            @foreach($donations as $donation)
                                @php
                                    ...
                                    $name = pickFirstString($donation['author']['name'] ?? null, $donation['donator_name'] ?? null) ?: __('betterplace.anonymous');
                                    $image = pickFirstString($donation['author']['picture']['links'][0]['href'] ?? null, $donation['donator_picture'] ?? null);
                                ...
                                <div class="border-b border-gray-300/80 py-4 last:border-b-0 dark:border-white/15">
                                    <div class="flex items-start gap-4">
                                        <div class="w-20 shrink-0 bg-gradient-to-r from-purple-700 to-cyan-700 bg-clip-text text-base font-bold text-transparent dark:from-purple-300 dark:to-cyan-300">
                                        ...
                                        <div class="min-w-0 flex-1">
                                            <div class="truncate text-sm font-semibold text-gray-900 dark:text-white/90">
                                                {{ $name }}
                                            </div>
                                            @if($message)
                ...
                <div class="border-t border-gray-300/80 pt-4 sm:pt-6 dark:border-white/15">
                    <div class="flex justify-center">
                        <a
                            href="https://secure.betterplace.org/de/donate/platform/fundraising-events/{{ EVENT_ID }}"
                            target="_blank"
